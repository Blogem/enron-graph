...
// Location: specs/004-explorer-chat/contracts/chat-api.ts
// Purpose: Define TypeScript types for the chat interface
...
export const CHAT_CONFIG = {
    ...
    DEFAULT_PLACEHOLDER: "Ask about the knowledge graph...",

    /** Default collapsed height in pixels */
    COLLAPSED_HEIGHT: 40,

    /** Default expanded height in pixels */
    EXPANDED_HEIGHT: 300,
} as const;
